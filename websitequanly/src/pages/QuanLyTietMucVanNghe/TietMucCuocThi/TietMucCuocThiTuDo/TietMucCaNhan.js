...
export default function TietMucCaNhan() {
  ...
  const handleFilter = () => {
    if (batDau == null)
      ...
      if (selectRadio == 1) {
        Axios.post(
          `http://localhost:3001/api/admin/alltietmuc/cuocthicanhan/ngay`,
          {
            NgayBatDau: batDau,
            NgayKetThuc: ketThuc,
          }
      ...
      if (selectRadio == 2) {
        Axios.post(
          `http://localhost:3001/api/admin/alltietmuc/cuocthicanhan/thang`,
          {
            NgayBatDau: batDau,
            NgayKetThuc: ketThuc,
          }
      ...
      if (selectRadio == 3) {
        Axios.post(
          `http://localhost:3001/api/admin/alltietmuc/cuocthicanhan/nam`,
          {
            NgayBatDau: batDau,
            NgayKetThuc: ketThuc,
          }
  ...
  useEffect(() => {
    const getDataTietMuc = async () => {
      const { data } = await Axios.post(
        "http://localhost:3001/api/admin/alltietmuc/cuocthicanhan"
      );
      data.forEach((d) => {
        if (d.VongThi == d.SoVongThi) {
          d.VongThi = "Chung kết";
          ...
          return (
            <MuiToolTip title={tableMeta.rowData[11] == 3 ? "View" : "Edit"}>
              <IconButton
                ...
                onClick={() => {
                  navigate(
                    `/chinhsuacuocthi/${tableMeta.rowData[0]}/canhan/chinhsuatietmuc/${tableMeta.rowData[1]}`
                  );
                }}
              >
            ...
            <Col xs="12" md="4">
              ...
              >
                ...
                <Form.Check
                  ...
                  label={
                    <>
                      <label htmlFor="dateCTCN1">Ngày</label>
                    </>
                  }
                  defaultChecked
                ...
                <Form.Check
                  ...
                  label={
                    <>
                      <label htmlFor="dateCTCN2">Tháng</label>
                    </>
                  }
                  onChange={(e) => handleRadioChange(e)}
                  // style={{ marginRight: "50px" }}
                ...
                <Form.Check
                  ...
                  label={
                    <>
                      <label htmlFor="dateCTCN3">Năm</label>
                    </>
                  }
                  onChange={(e) => handleRadioChange(e)}
                  // style={{ marginRight: "50px" }}
